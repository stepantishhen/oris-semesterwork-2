...
export default function PublicProfile({}: Props) {
  ...
  return (
    ...
    {blogsdata.map((blog) => 
      ...
      <div className="container d-flex flex-wrap">
      <div className=" align-self-center align-items-center align-content-center">
        <h1 className="text-center pb-2">Друзья</h1>
      </div>
    ...
    {return connection.accepted===true &&
      <>
        ...
        <Card
          ...
          <Card.Body className="m-0 p-0">
            ...
            <div className='col-3 text-center mt-1'><Button onClick={()=>handleRemove(connection.id)}>Удалить</Button></div>
            </div>
          </Card.Body>
        </Card>
        </Link>
      ...
      <div className="container d-flex flex-wrap">
      <div className=" align-self-center align-items-center align-content-center">
        <h1 className="text-center pb-2">Подписчики</h1>
      </div>
    {connections.map((connection) => 
    {return connection.following===true &&
      ...
      <div className="container d-flex flex-wrap">
      <div className=" align-self-center align-items-center align-content-center">
        <h1 className="text-center pb-2">Запросы на дружбу</h1>
      </div>
    {connections.map((connection) => 
      ...
      <>
        ...
        <Card
          ...
          <Card.Body className="m-0 p-0">
            ...
            <div className='col-3 text-center mt-1'><Button onClick={()=>handleAccept(connection.id, connection.sender.id)}>Принять запрос</Button></div>
            </div>
          </Card.Body>
        </Card>
        </Link>
