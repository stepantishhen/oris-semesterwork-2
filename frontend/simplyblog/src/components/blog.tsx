    ...
    <div>
      ...
      <div className="container-fluid py-5">
        ...
        <button
          ...
          type="button"
          >{likes} Лайк <FontAwesomeIcon icon={faThumbsUp} />
        </button>
        <button
          ...
          type="button">
          {unlikes} Дизлайк <FontAwesomeIcon icon={faThumbsDown} />
        </button>
        <p className="fs-10 text-end">Дата публикации: {blogdata?.publishedDate}</p>
      </div>
      </div>  
    </div>
  )
